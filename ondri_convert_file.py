from Files.Converters import *  # Code from owcurate


def bin_to_edf(file_in, out_path, accel=True, temperature=False, light=False, button=False):
    ...
    GENEActivToEDF(GENEActiv=geneactiv_object, path=out_path,
                   accel=save_accel, temperature=save_temp, light=save_light, button=save_button)
